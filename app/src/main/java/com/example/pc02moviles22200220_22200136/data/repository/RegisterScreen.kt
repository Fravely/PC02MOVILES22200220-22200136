package com.example.pc02moviles22200220_22200136.data.repository
...
fun RegisterScreen(navController: NavController) {
    ...
    Column(
        ...
        Text("Registro de Equipo", style = androidx.compose.material3.MaterialTheme.typography.headlineMedium)
